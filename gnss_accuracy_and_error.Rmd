...
![Three frames with error circles](images/gnss_error.svg)

**Figure 0: Satellite configurations and the resulting shapes and areas of inaccuracy.**
...
**Figure 7: The movement and selection of satellites used during the Belval walk. The perspective here is top-down, like looking at a map.**
...
**Figure 8: During the walk the GPS constellation where 50-60% of the satellites with the remainder belonging to GLONASS. Despite this about 80% of the satellites used to determine location where from the GPS constellation with the remainder from GLONASS.**
...
Looking again at Figure 0, consider how different satellite positions could impact DOP types differently.
...
**Figure 9: Different DOP values along the walk. DOP fluctuations are higher when positional error is greater.**
